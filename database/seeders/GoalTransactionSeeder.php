...
class GoalTransactionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $deposits = [
            // Deposits for Goal 1 (Gerbang Masjid) - Spread over 6 months
            [
                'goal_id' => $goal1->id,
                'donor_name' => 'H. Ahmad Dahlan',
                'amount' => 10000000,
                'notes' => 'Semoga bermanfaat untuk pembangunan masjid',
                'deposit_date' => Carbon::now()->subMonths(5),
            ...
            [
                ...
                'deposit_date' => Carbon::now()->subMonths(4)->subDays(15),
                'payment_method' => 'Cash',
                'recorded_by' => $superAdmin->id,
            ],
            [
                ...
                'deposit_date' => Carbon::now()->subMonths(3)->subDays(20),
                'payment_method' => 'Cash',
                'recorded_by' => $superAdmin->id,
            ],
            [
                ...
                'deposit_date' => Carbon::now()->subMonths(2)->subDays(10),
                'payment_method' => 'Transfer Bank',
                'recorded_by' => $superAdmin->id,
            ],
            [
                'goal_id' => $goal1->id,
                'donor_name' => 'Donatur Anonim 1',
                'amount' => 8000000,
                'notes' => 'Untuk pembangunan',
                'deposit_date' => Carbon::now()->subMonths(1)->subDays(5),
                'payment_method' => 'Transfer Bank',
                'recorded_by' => $superAdmin->id,
            ],
            [
                'goal_id' => $goal1->id,
                'donor_name' => 'Keluarga Besar Pak RT',
                'amount' => 4500000,
                'notes' => 'Patungan warga',
                'deposit_date' => Carbon::now()->subDays(10),
                'payment_method' => 'Cash',
                'recorded_by' => $superAdmin->id,
            ],
            
            // Deposits for Goal 2 (Renovasi) - Spread over months
            [
                'goal_id' => $goal2->id,
                'donor_name' => 'Bapak Usman',
                'amount' => 7500000,
                'notes' => 'Untuk renovasi masjid',
                'deposit_date' => Carbon::now()->subMonths(4),
                'payment_method' => 'Transfer Bank',
                'recorded_by' => $superAdmin->id,
            ],
            [
                ...
                'amount' => 2500000,
                'notes' => null,
                'deposit_date' => Carbon::now()->subMonths(3)->subDays(15),
                'payment_method' => 'E-Wallet',
                'recorded_by' => $superAdmin->id,
            ],
            [
                'goal_id' => $goal2->id,
                'donor_name' => 'Pengajian Ibu-ibu',
                'amount' => 3200000,
                'notes' => 'Hasil arisan',
            ...
            [
                'goal_id' => $goal2->id,
                'donor_name' => 'Remaja Masjid',
                'amount' => 1800000,
                'notes' => 'Hasil kegiatan',
                'deposit_date' => Carbon::now()->subMonths(1)->subDays(10),
                'payment_method' => 'Transfer Bank',
                'recorded_by' => $superAdmin->id,
            ],
            [
                ...
                'amount' => 6000000,
                'notes' => 'Infaq renovasi',
                'deposit_date' => Carbon::now()->subDays(5),
                'payment_method' => 'Transfer Bank',
                'recorded_by' => $superAdmin->id,
            ],
            
            // Deposits for Goal 3 (Santunan) - Monthly deposits
            [
                'goal_id' => $goal3->id,
            ...
            [
                ...
                'deposit_date' => Carbon::now()->subMonths(4)->subDays(10),
                'payment_method' => 'Cash',
                'recorded_by' => $superAdmin->id,
            ],
            [
                'goal_id' => $goal3->id,
                'donor_name' => 'Yayasan Peduli Yatim',
                'amount' => 4200000,
                'notes' => 'Program santunan',
            ...
            [
                'goal_id' => $goal3->id,
                'donor_name' => 'Ibu Khadijah',
                'amount' => 2800000,
                'notes' => 'Untuk anak yatim',
                'deposit_date' => Carbon::now()->subMonths(2)->subDays(15),
                'payment_method' => 'E-Wallet',
                'recorded_by' => $superAdmin->id,
            ],
            [
                'goal_id' => $goal3->id,
                'donor_name' => 'Komunitas Berbagi',
                'amount' => 3300000,
                'notes' => 'Santunan bulanan',
            ...
            [
                'goal_id' => $goal3->id,
                'donor_name' => 'Donatur Tetap',
                'amount' => 2500000,
                'notes' => 'Rutin bulanan',
                'deposit_date' => Carbon::now()->subDays(7),
                'payment_method' => 'Transfer Bank',
                'recorded_by' => $superAdmin->id,
            ],
