<x-app-layout>
                ...
                <div class="p-8">
                    <form action="{{ route('accounts.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Enter account name"
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="cash" {{ (old('type') ?? $selectedType ?? '') === 'cash' ? 'selected' : '' }}>Kas</option>
                                <option value="bank" {{ (old('type') ?? $selectedType ?? '') === 'bank' ? 'selected' : '' }}>Bank</option>
    ...
    <script>
        ...
        if (balanceInput.value || {{ old('balance', 0) }}) {
            let value = {{ old('balance', 0) }};
            if (value) {
