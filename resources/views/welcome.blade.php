            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="text-center lg:text-left animate-fade-in">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="{{ route('register') }}" class="px-8 py-4 bg-amber text-white font-semibold rounded-xl hover:bg-amber-dark transition-all duration-300 btn-primary shadow-amber-lg text-lg">
                            Mulai Sekarang
                        </a>
    ...
    <section id="laporan" class="py-20 lg:py-28 bg-cream border-t border-b border-amber-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-3xl mx-auto mb-12">
                <form action="{{ route('login') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="{{ route('login') }}" class="bg-white rounded-2xl p-6 shadow-amber-sm hover-lift block">
            ...
            <div class="text-center mt-10">
                <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-amber font-semibold hover:text-amber-dark transition-colors">
                    Lihat Semua Masjid
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-amber-sm">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 border-2 border-amber text-amber font-semibold rounded-xl text-center hover:bg-amber hover:text-white transition-all btn-outline">
                        Mulai Gratis
                    </a>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-amber-lg pricing-highlight transform scale-105">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 bg-amber text-white font-semibold rounded-xl text-center hover:bg-amber-dark transition-all btn-primary shadow-amber">
                        Pilih Pro
                    </a>
                </div>
    ...
    <section class="py-16 lg:py-20 bg-amber">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') }}" class="px-8 py-4 bg-white text-amber font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 shadow-lg">
                    Daftar sebagai Pengurus Masjid
                </a>
                <a href="{{ route('login') }}" class="px-8 py-4 border-2 border-white text-white font-semibold rounded-xl hover:bg-white/10 transition-all duration-300">
