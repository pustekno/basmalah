...
<body class="bg-gray-50 font-body text-gray-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="{{ url('/') }}" class="flex items-center space-x-3 hover-scale">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-gray-600 hover:text-primary font-medium transition-colors hover:scale-105 inline-block">Masuk</a>
                        <a href="{{ route('register') }}" class="btn-primary bg-primary text-white px-6 py-2.5 rounded-xl font-semibold shadow-lg shadow-primary/30">Daftar Gratis</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <section class="pt-24 pb-16 lg:pt-32 lg:pb-24 pattern-dots relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 mb-16 reveal delay-200">
                <a href="{{ route('register') }}" class="btn-primary bg-primary text-white px-8 py-4 rounded-xl font-semibold text-center shadow-lg shadow-primary/30 inline-flex items-center justify-center hover-scale">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="reveal delay-100 pricing-card bg-white border-2 border-gray-100 rounded-2xl p-6 cursor-pointer hover:border-primary/30">
                    ...
                    <a href="{{ route('register') }}" class="block w-full border-2 border-primary text-primary py-2.5 rounded-xl font-semibold text-center hover:bg-primary hover:text-white transition-colors text-sm">
                        Mulai Gratis
                    </a>
                </div>
                ...
                <div class="reveal delay-200 pricing-card bg-primary-lightest border-2 border-primary rounded-2xl p-6 relative transform scale-105 shadow-xl shadow-primary/10 cursor-pointer">
                    ...
                    <a href="{{ route('register') }}?plan=pro" class="block w-full bg-primary text-white py-2.5 rounded-xl font-semibold text-center hover:bg-primary-dark transition-colors text-sm">
                        Pilih Pro
                    </a>
                </div>
                ...
                <div class="reveal delay-300 pricing-card bg-white border-2 border-gray-100 rounded-2xl p-6 cursor-pointer hover:border-primary/30">
                    ...
                    <a href="{{ route('register') }}?plan=premium" class="block w-full border-2 border-gray-300 text-gray-600 py-2.5 rounded-xl font-semibold text-center hover:border-primary hover:text-primary transition-colors text-sm">
                        Pilih Premium
                    </a>
                </div>
            </div>
    ...
    <section class="py-20 bg-primary-lightest hover-lift">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('register') }}" class="btn-primary inline-block bg-primary text-white px-10 py-4 rounded-xl font-semibold shadow-lg shadow-primary/30 hover-scale">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex items-center space-x-6 text-sm text-gray-600">
                    ...
                    <a href="{{ route('login') }}" class="hover:text-primary transition-colors hover:scale-105 inline-block">Masuk</a>
                    <a href="{{ route('register') }}" class="hover:text-primary transition-colors hover:scale-105 inline-block">Daftar</a>
                </div>
            </div>
            <div class="mt-8 pt-8 border-t border-gray-100 text-center text-gray-500 text-sm">
                <p>&copy; {{ date('Y') }} Basmallah. All rights reserved.</p>
            </div>
        </div>
    </footer>
