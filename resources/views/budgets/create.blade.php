                ...
                <div class="p-8">
                    <form action="{{ route('budgets.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Enter budget name"
                        ...
                        <div>
                            ...
                            <input type="text" name="amount_display" id="amount_display" value="{{ old('amount_display') }}" required placeholder="100.000"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all duration-200">
