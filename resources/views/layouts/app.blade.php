                ...
                <footer class="bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 mt-12 lg:mt-16 px-6 lg:px-8 py-3">
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            &copy; {{ date('Y') }} <button type="button" @click="$dispatch('open-modal', 'about')" class="text-primary hover:underline">Basmallah</button>. All rights reserved.
                        </p>
                        ...
                        <div x-show="open"
                            ...
                            <div class="px-6 py-5 max-h-[60vh] overflow-y-auto">
                                ...
                                <div class="text-center pt-2">
                                    <p class="text-xs text-gray-500 dark:text-gray-400">© {{ date('Y') }} Basmallah. All rights reserved.</p>
