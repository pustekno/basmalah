                ...
                <form method="POST" action="{{ route('login') }}" x-data="{ showPass: false }">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="nama@email.com" class="form-input">
                        </div>
                        @error('email')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper" style="position: relative;">
                            ...
                            <input :type="showPass ? 'text' : 'password'" id="password" name="password" required autocomplete="current-password" placeholder="Masukkan password Anda" class="form-input" style="padding-right: 45px;">
