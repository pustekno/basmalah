...
<head>
    ...
    <title>{{ config('app.name', 'Basmallah') }} – Login</title>
    ...
    <div class="container">
        ...
        <div class="right-panel">
            <div class="form-container" x-data="{
                showRegister: {{ $showRegister ?? false ? 'true' : 'false' }}
            }">
                <!-- Mobile Logo -->
                ...
                <div x-show="!showRegister" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0">
                    ...
                    <form method="POST" action="{{ route('auth.login') }}" x-data="{ showPass: false }">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="email" id="login-email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="nama@email.com" class="form-input">
                ...
                <div x-show="showRegister" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0">
                    ...
                    <form method="POST" action="{{ route('auth.register') }}" x-data="{ showPass: false, showPassConfirm: false }">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" id="register-name" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Nama lengkap Anda" class="form-input">
                                <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="email" id="register-email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="nama@email.com" class="form-input">
                                <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                            </div>
