                    ...
                    <a href="{{ route('reports.by-account', array_merge(request()->query(), ['account_id' => $account->id])) }}" 
                        ...
                        <div class="grid grid-cols-2 gap-2 text-sm">
                            <div>
                                ...
                                <p class="font-medium text-green-600 dark:text-green-400">Rp {{ number_format($account->transactions_sum_amount ?? 0, 0, ',', '.') }}</p>
                            </div>
                            <div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="grid grid-cols-3 gap-4 p-6 border-b border-gray-100 dark:border-slate-700">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-xl font-bold text-green-600 dark:text-green-400">Rp {{ number_format($transactions->where('type', 'income')->sum('amount'), 0, ',', '.') }}</p>
                        </div>
                        <div class="text-center">
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Pengeluaran</p>
                            <p class="text-xl font-bold text-red-600 dark:text-red-400">Rp {{ number_format($transactions->where('type', 'expense')->sum('amount'), 0, ',', '.') }}</p>
                        </div>
                    </div>
