        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form action="{{ route('transactions.store') }}" method="POST" class="space-y-6">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 space-y-5">
                    ...
                    <!-- Upcoming Flag -->
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="upcoming_flag" id="upcoming_flag" value="1" {{ old('upcoming_flag') ? 'checked' : '' }}
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('transactions.index') }}" class="flex-1 bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-medium py-3.5 px-6 rounded-xl transition-all duration-200 text-center">
                        Cancel
                    </a>
                </div>
            </form>
