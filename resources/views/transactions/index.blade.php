<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('transactions.create') }}" class="inline-flex items-center px-4 py-2 bg-primary border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-primary-dark transition-colors shadow-md hover:shadow-lg">
