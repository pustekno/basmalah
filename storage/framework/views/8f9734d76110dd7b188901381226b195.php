...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Buat Target Baru')); ?>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('goals.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="target_amount" id="target_amount" value="<?php echo e(old('target_amount')); ?>" required min="0" step="0.01"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex justify-end gap-2">
                            <a href="<?php echo e(route('goals.index')); ?>" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 rounded">
                                Batal
                            </a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\basmalah\resources\views/goals/create.blade.php ENDPATH**/ ?>