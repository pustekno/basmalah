    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
                <div class="p-8">
                    <form action="<?php echo e(route('budgets.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" required placeholder="Enter budget name"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="amount_display" id="amount_display" value="<?php echo e(old('amount_display')); ?>" required placeholder="100.000"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all duration-200">
                            <input type="hidden" name="amount" id="amount" value="<?php echo e(old('amount')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        if (amountInput.value) {
            ...
            if (value) {
                amountInput.value = formatNumber(parseInt(value));
                amountHidden.value = parseInt(value);
            }
        }
    </script>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\project-basmalah\basmallah\resources\views/budgets/create.blade.php ENDPATH**/ ?>