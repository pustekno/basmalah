    ...
    <?php if(session('success')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                notifySuccess('Transaksi Baru', '<?php echo e(session('success')); ?>');
            });
        </script>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\project-basmalah\basmallah\resources\views/transactions/index.blade.php ENDPATH**/ ?>