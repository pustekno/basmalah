...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5 fade-in-up fade-in-up-delay-1">
        <?php echo csrf_field(); ?>
        ...
        <div x-data="{ showPass: false }">
            <div class="flex items-center justify-between mb-2">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors duration-200">
                        Lupa password?
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
        ...
        <div class="text-center">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="font-bold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors duration-200 ml-1">
                    Daftar sekarang →
                </a>
            </p>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\gitclone\masjid\basmalah\resources\views/auth/login.blade.php ENDPATH**/ ?>