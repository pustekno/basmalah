...
<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 transform transition-transform duration-300 ease-in-out" :class="{ '-translate-x-full': !sidebarOpen }">
    <div class="flex flex-col h-full">
        ...
        <div class="px-4 py-3 border-b border-gray-200 dark:border-slate-700">
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" x-transition class="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden z-50">
                    ...
                    <?php endif; ?>
                    <?php $__currentLoopData = \App\Models\Masjid::where('is_active', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $masjid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <nav class="flex-1 overflow-y-auto px-2 py-4 space-y-1" :class="{ 'px-2': sidebarCollapsed, 'px-4': !sidebarCollapsed }">
            <!-- Dashboard -->
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all <?php echo e(request()->routeIs('dashboard') ? 'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700/50'); ?>" :class="{ 'justify-center': sidebarCollapsed }" title="<?php echo e(__('navigation.dashboard')); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="font-medium"><?php echo e(__('navigation.dashboard')); ?></span>
            </a>
            ...
            <!-- Categories -->
            <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all <?php echo e(request()->routeIs('categories.*') ? 'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700/50'); ?>" :class="{ 'justify-center': sidebarCollapsed }" title="<?php echo e(__('navigation.categories')); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="font-medium"><?php echo e(__('navigation.categories')); ?></span>
            </a>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view budgets')): ?>
            <!-- Budgets -->
            <a href="<?php echo e(route('budgets.index')); ?>" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all <?php echo e(request()->routeIs('budgets.*') ? 'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700/50'); ?>" :class="{ 'justify-center': sidebarCollapsed }" title="<?php echo e(__('navigation.budgets')); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="font-medium"><?php echo e(__('navigation.budgets')); ?></span>
            </a>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\basmalah\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>