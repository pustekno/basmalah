            ...
            Alpine.data('transactionForm', function() {
                return {
                    ...
                    updateAmount() {
                        ...
                        if (value) {
                            // Remove thousand separators for calculation
                            let cleanValue = value.replace(/\./g, '');
                            // Convert comma to decimal point if present
                    ...
                    formatOnBlur() {
                        // Format with thousand separators only on blur
                        let value = this.amountDisplay.replace(/[^\d,]/g, '');
                        if (value) {
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <form action="<?php echo e(route('transactions.store')); ?>" method="POST" enctype="multipart/form-data" x-data="transactionForm()">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="account_id" id="account_id" required
                                        ...
                                        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($account->id); ?>" <?php echo e(old('account_id', $selectedAccount) == $account->id ? 'selected' : ''); ?>>
                        ...
                        <div class="bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-amber-800/10 rounded-2xl p-5 border border-amber-200 dark:border-amber-800/30">
                            <label class="flex items-start gap-4 cursor-pointer">
                                <div class="relative flex items-center">
                                    <input type="checkbox" name="upcoming_flag" value="1" <?php echo e(old('upcoming_flag') ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-end gap-4 px-8 py-6 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700">
                        <a href="<?php echo e(route('transactions.index')); ?>" class="px-6 py-3 text-sm font-semibold text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-gray-200 transition-all">
                            Cancel
                        </a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\basmalah\resources\views/transactions/create.blade.php ENDPATH**/ ?>