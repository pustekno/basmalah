...
<body class="bg-gray-50 dark:bg-slate-900 min-h-screen">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-10 text-center">
            ...
            <!-- Button -->
            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-6 py-3 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl">
...
<?php /**PATH D:\laragon\www\project-basmalah\basmallah\resources\views/errors/403.blade.php ENDPATH**/ ?>