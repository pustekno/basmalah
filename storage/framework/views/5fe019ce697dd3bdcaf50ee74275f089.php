...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('categories.edit')); ?>

        </h2>
        <a href="<?php echo e(route('categories.index')); ?>" class="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-xl font-medium text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                ...
                <div class="p-8">
                    <form action="<?php echo e(route('categories.update', $category)); ?>" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="<?php echo e(old('name', $category->name)); ?>" required placeholder="Enter category name"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="income" <?php echo e(old('type', $category->type) == 'income' ? 'selected' : ''); ?>>Income</option>
                                <option value="expense" <?php echo e(old('type', $category->type) == 'expense' ? 'selected' : ''); ?>>Expense</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" placeholder="Enter description (optional)"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all duration-200 resize-none"><?php echo e(old('description', $category->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="flex gap-4 items-center">
                                <input type="color" name="color" id="color" value="<?php echo e(old('color', $category->color)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="order" id="order" value="<?php echo e(old('order', $category->order)); ?>" min="0" placeholder="0"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all duration-200">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <a href="<?php echo e(route('categories.index')); ?>" class="flex-1 bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-medium py-3.5 px-6 rounded-xl transition-all duration-200 text-center">
                                Cancel
                            </a>
                        </div>
                    </form>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\project-basmalah\basmallah\resources\views/categories/edit.blade.php ENDPATH**/ ?>