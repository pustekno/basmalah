    ...
    <?php if(session('success')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                notifySuccess('Budget Updated', '<?php echo e(session('success')); ?>');
            });
        </script>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\project-basmalah\basmallah\resources\views/budgets/index.blade.php ENDPATH**/ ?>