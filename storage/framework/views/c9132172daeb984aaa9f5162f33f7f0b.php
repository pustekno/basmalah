...
<body class="bg-gray-100 dark:bg-gray-900">
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 text-center">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                Go to Dashboard
            </a>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\basmalah\resources\views/errors/403.blade.php ENDPATH**/ ?>