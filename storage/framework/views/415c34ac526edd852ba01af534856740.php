     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-extrabold text-xl text-gray-900 dark:text-white leading-tight">
                <?php echo e(__('Account Management')); ?>

            </h2>
            <a href="<?php echo e(route('accounts.create')); ?>" class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-xl font-semibold text-sm text-white hover:bg-emerald-700 transition-colors shadow-lg hover:shadow-xl">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-extrabold mt-1">Rp <?php echo e(number_format($totalBalance, 0, ',', '.')); ?></h3>
                        <p class="text-emerald-100/70 text-sm mt-1"><?php echo e($accounts->count()); ?> accounts</p>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="<?php echo e(route('accounts.create')); ?>?type=cash" class="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700 p-4 hover:shadow-xl hover:border-emerald-300 dark:hover:border-emerald-600 transition-all group">
                ...
                <a href="<?php echo e(route('accounts.create')); ?>?type=bank" class="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700 p-4 hover:shadow-xl hover:border-blue-300 dark:hover:border-blue-600 transition-all group">
                ...
                <a href="<?php echo e(route('accounts.create')); ?>?type=e-wallet" class="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700 p-4 hover:shadow-xl hover:border-purple-300 dark:hover:border-purple-600 transition-all group">
                ...
                <a href="<?php echo e(route('accounts.create')); ?>?type=credit_card" class="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700 p-4 hover:shadow-xl hover:border-orange-300 dark:hover:border-orange-600 transition-all group">
                ...
                <div class="divide-y divide-gray-100 dark:divide-slate-700">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center flex-1 min-w-0">
                                    <a href="<?php echo e(route('accounts.show', $account)); ?>" class="flex items-center flex-1 min-w-0">
                                        ...
                                        <?php elseif($account->type === 'e-wallet'): ?>
                                ...
                                <div class="flex items-center gap-3 ml-4">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="<?php echo e(route('accounts.show', $account)); ?>" class="p-2 text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                            </svg>
                                        </a>
                                        <a href="<?php echo e(route('accounts.edit', $account)); ?>" class="p-2 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('accounts.destroy', $account)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this account?');">
                                            <?php echo csrf_field(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="p-8 text-center">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('accounts.create')); ?>" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-xl transition-colors shadow-lg hover:shadow-xl">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                    Add Account
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\basmalah\resources\views/accounts/index.blade.php ENDPATH**/ ?>