            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        Edit Target: <?php echo e($goal->title); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-4">
                                ...
                                <p class="font-bold text-gray-900 dark:text-white text-lg">Rp <?php echo e(number_format($goal->target_amount, 0, ',', '.')); ?></p>
                            </div>
                            <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-4">
                                ...
                                <p class="font-bold text-gray-900 dark:text-white text-lg">Rp <?php echo e(number_format($goal->current_amount, 0, ',', '.')); ?></p>
                            </div>
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-4">
                                ...
                                <p class="font-bold text-gray-900 dark:text-white text-lg">Rp <?php echo e(number_format($goal->remaining_amount, 0, ',', '.')); ?></p>
                            </div>
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-4">
                                ...
                                <p class="font-bold text-gray-900 dark:text-white text-lg"><?php echo e($goal->target_amount > 0 ? number_format(min(($goal->current_amount / $goal->target_amount) * 100, 100), 1) : 0); ?>%</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex justify-between text-sm mb-2">
                                ...
                                <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($goal->target_amount > 0 ? number_format(min(($goal->current_amount / $goal->target_amount) * 100, 100), 1) : 0); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-3">
                                <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 h-3 rounded-full transition-all duration-500" style="width: <?php echo e($goal->target_amount > 0 ? min(($goal->current_amount / $goal->target_amount) * 100, 100) : 0); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex justify-between text-sm mb-2">
                                ...
                                <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($goal->progress_percentage ?? 0, 1)); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-3">
                                <div class="bg-gradient-to-r from-green-400 to-green-600 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(min($goal->progress_percentage ?? 0, 100)); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-slate-700">
                            ...
                            <form method="POST" action="<?php echo e(route('goals.updateProgress', $goal)); ?>" class="flex gap-3 items-end">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                <div class="flex-1">
                                    <label for="progress_percentage" class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Persentase Pengerjaan (%)</label>
                                    <input type="number" name="progress_percentage" id="progress_percentage" min="0" max="100" step="0.1" value="<?php echo e($goal->progress_percentage ?? 0); ?>" required
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
                                        <div class="flex-1">
                                            <div class="flex items-center gap-2 mb-1">
                                                <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($deposit->donor_name); ?></p>
                                                <?php if($deposit->account): ?>
                                                    <span class="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-lg"><?php echo e($deposit->account->name); ?></span>
                                                <?php endif; ?>
                                            </div>
                                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($deposit->deposit_date->format('d M Y')); ?></p>
                                            <?php if($deposit->notes): ?>
                                                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1"><?php echo e($deposit->notes); ?></p>
                                            <?php endif; ?>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <p class="font-bold text-green-600 dark:text-green-400">+Rp <?php echo e(number_format($deposit->amount, 0, ',', '.')); ?></p>
                                            <form action="<?php echo e(route('deposits.destroy', $deposit)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus deposit ini? Saldo akan dikembalikan ke akun.')">
                                                <?php echo csrf_field(); ?>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 sticky top-6">
                        ...
                        <form method="POST" action="<?php echo e(route('goals.update', $goal)); ?>" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="<?php echo e(old('title', $goal->title)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all resize-none"><?php echo e(old('description', $goal->description)); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="target_amount_display" value="<?php echo e(number_format($goal->target_amount, 0, ',', '.')); ?>"
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
                                <input type="hidden" name="target_amount" id="target_amount" value="<?php echo e($goal->target_amount); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="progress_percentage" id="progress_percentage" min="0" max="100" step="0.1" value="<?php echo e(old('progress_percentage', $goal->progress_percentage ?? 0)); ?>" required
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="category" id="category" value="<?php echo e(old('category', $goal->category)); ?>"
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="date" name="start_date" id="start_date" value="<?php echo e(old('start_date', $goal->start_date->format('Y-m-d'))); ?>" required
                                        class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
                                </div>
                                <div>
                                    <label for="end_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Selesai</label>
                                    <input type="date" name="end_date" id="end_date" value="<?php echo e(old('end_date', $goal->end_date->format('Y-m-d'))); ?>" required
                                        class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
                                    <option value="active" <?php echo e(old('status', $goal->status) === 'active' ? 'selected' : ''); ?>>Active</option>
                                    <option value="completed" <?php echo e(old('status', $goal->status) === 'completed' ? 'selected' : ''); ?>>Completed</option>
                                    <option value="cancelled" <?php echo e(old('status', $goal->status) === 'cancelled' ? 'selected' : ''); ?>>Cancelled</option>
                                </select>
                            </div>
                            ...
                            <div class="flex flex-col gap-2 pt-4">
                                ...
                                <a href="<?php echo e(route('goals.index')); ?>" class="w-full bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-medium py-2.5 px-6 rounded-xl transition-all duration-200 text-center">
                                    Kembali
                                </a>
                            </div>
                        </form>
    ...
    <div id="depositModal" class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <form method="POST" action="<?php echo e(route('deposits.store', $goal)); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="account_id" id="account_id" required
                            ...
                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($account->id); ?>"><?php echo e($account->name); ?> - Rp <?php echo e(number_format($account->balance, 0, ',', '.')); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="deposit_date" id="deposit_date" value="<?php echo e(date('Y-m-d')); ?>" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-300 text-gray-900 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/30 transition-all">
                    </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\project-basmalah\basmallah\resources\views/goals/edit.blade.php ENDPATH**/ ?>